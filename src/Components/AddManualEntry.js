...
import { Button, FormControl, FormControlLabel, FormHelperText, FormLabel, Grid, MenuItem, Paper, Radio, RadioGroup, Stack, TextField, Typography } from "@mui/material";
...
const AddManualEntry = () => {
    ...
    const validate = (fieldValues = values) => {
        ...
        if ('blockers' in fieldValues)
            temp.blockers = fieldValues.blockers ? (fieldValues.blockers < 0 || fieldValues.blockers % 1 !== 0) ? "Not a valid Number" : "" : "Blockers field is required."
        if ('critical' in fieldValues)
            temp.critical = fieldValues.critical ? (fieldValues.critical < 0 || fieldValues.critical % 1 !== 0) ? "Not a valid Number" : "" : "Critical field is required."
        if ('major' in fieldValues)
            temp.major = fieldValues.major ? (fieldValues.major < 0 || fieldValues.major % 1 !== 0) ? "Not a valid Number" : "" : "Major field is required."
        if ('minor' in fieldValues)
            temp.minor = fieldValues.minor ? (fieldValues.minor < 0 || fieldValues.minor % 1 !== 0) ? "Not a valid Number" : "" : "Minor field is required."
        if ('rejected' in fieldValues)
            temp.rejected = fieldValues.rejected ? (fieldValues.rejected < 0 || fieldValues.rejected % 1 !== 0) ? "Not a valid Number" : "" : "Rejected field is required."
        if ('defectsRetested' in fieldValues)
            temp.defectsRetested = fieldValues.defectsRetested ? (fieldValues.defectsRetested < 0 || fieldValues.defectsRetested % 1 !== 0) ? "Not a valid Number" : "" : "Defects Retested field is required."
        if ('defectsFixed' in fieldValues)
            temp.defectsFixed = fieldValues.defectsFixed ? (fieldValues.defectsFixed < 0 || fieldValues.defectsFixed % 1 !== 0) ? "Not a valid Number" : "" : "Defects Fixed field is required."
        if ('plannedTcs' in fieldValues)
            temp.plannedTcs = fieldValues.plannedTcs ? (fieldValues.plannedTcs < 0 || fieldValues.plannedTcs % 1 !== 0) ? "Not a valid Number" : "" : "Planned Tcs field is required."
        if ('executedTcs' in fieldValues)
            temp.executedTcs = fieldValues.executedTcs ? (fieldValues.executedTcs < 0 || fieldValues.executedTcs % 1 !== 0) ? "Not a valid Number" : "" : "Executed Tcs field is required."
        if ('passedTcs' in fieldValues)
            temp.passedTcs = fieldValues.passedTcs ? (fieldValues.passedTcs < 0 || fieldValues.passedTcs % 1 !== 0) ? "Not a valid Number" : "" : "Passed Tcs field is required."
        if ('failedTcs' in fieldValues)
            temp.failedTcs = fieldValues.failedTcs ? (fieldValues.failedTcs < 0 || fieldValues.failedTcs % 1 !== 0) ? "Not a valid Number" : "" : "Failed Tcs field is required."
        if ('blockedTcs' in fieldValues)
            temp.blockedTcs = fieldValues.blockedTcs ? (fieldValues.blockedTcs < 0 || fieldValues.blockedTcs % 1 !== 0) ? "Not a valid Number" : "" : "Blocked Tcs field is required."
        if ('p0' in fieldValues)
            temp.p0 = fieldValues.p0 ? (fieldValues.p0 < 0 || fieldValues.p0 % 1 !== 0) ? "Not a valid Number" : "" : "P0 field is required."
        if ('p1' in fieldValues)
            temp.p1 = fieldValues.p1 ? (fieldValues.p1 < 0 || fieldValues.p1 % 1 !== 0) ? "Not a valid Number" : "" : "P1 field is required."
        if ('p2' in fieldValues)
            temp.p2 = fieldValues.p2 ? (fieldValues.p2 < 0 || fieldValues.p2 % 1 !== 0) ? "Not a valid Number" : "" : "P2 field is required."
        if ('p3' in fieldValues)
            temp.p3 = fieldValues.p3 ? (fieldValues.p3 < 0 || fieldValues.p3 % 1 !== 0) ? "Not a valid Number" : "" : "P3 field is required."
        if ('p4' in fieldValues)
            temp.p4 = fieldValues.p4 ? (fieldValues.p4 < 0 || fieldValues.p4 % 1 !== 0) ? "Not a valid Number" : "" : "P4 field is required."
        if ('p0_updated' in fieldValues)
            temp.p0_updated = fieldValues.p0_updated ? (fieldValues.p0_updated < 0 || fieldValues.p0_updated % 1 !== 0) ? "Not a valid Number" : "" : "P0 in update field is required."
        if ('p1_updated' in fieldValues)
            temp.p1_updated = fieldValues.p1_updated ? (fieldValues.p1_updated < 0 || fieldValues.p1_updated % 1 !== 0) ? "Not a valid Number" : "" : "P1 in update field is required."
        if ('p2_updated' in fieldValues)
            temp.p2_updated = fieldValues.p2_updated ? (fieldValues.p2_updated < 0 || fieldValues.p2_updated % 1 !== 0) ? "Not a valid Number" : "" : "P2 in update  field is required."
        if ('p3_updated' in fieldValues)
            temp.p3_updated = fieldValues.p3_updated ? (fieldValues.p3_updated < 0 || fieldValues.p3_updated % 1 !== 0) ? "Not a valid Number" : "" : "P3 in update  field is required."
        if ('p4_updated' in fieldValues)
            temp.p4_updated = fieldValues.p4_updated ? (fieldValues.p4_updated < 0 || fieldValues.p4_updated % 1 !== 0) ? "Not a valid Number" : "" : "P4 in update  field is required."
        if ('r_blockers' in fieldValues)
            temp.r_blockers = fieldValues.r_blockers ? (fieldValues.r_blockers < 0 || fieldValues.r_blockers % 1 !== 0) ? "Not a valid Number" : "" : "Rejected blocker field is required."
        if ('r_critical' in fieldValues)
            temp.r_critical = fieldValues.r_critical ? (fieldValues.r_critical < 0 || fieldValues.r_critical % 1 !== 0) ? "Not a valid Number" : "" : "Rejected critical field is required."
        if ('r_major' in fieldValues)
            temp.r_major = fieldValues.r_major ? (fieldValues.r_major < 0 || fieldValues.r_major % 1 !== 0) ? "Not a valid Number" : "" : "Rejected major field is required."
        if ('r_minor' in fieldValues)
            temp.r_minor = fieldValues.r_minor ? (fieldValues.r_minor < 0 || fieldValues.r_minor % 1 !== 0) ? "Not a valid Number" : "" : "Rejected minor field is required."
        if ('executionTimeHours' in fieldValues)
            temp.executionTimeHours = fieldValues.executionTimeHours ? (fieldValues.executionTimeHours < 0 || fieldValues.executionTimeHours % 1 !== 0) ? "Not a valid Number" : "" : "Execution Time Hours field is required."
        if ('executionTimeMinutes' in fieldValues)
            temp.executionTimeMinutes = fieldValues.executionTimeMinutes ? (fieldValues.executionTimeMinutes < 0 || fieldValues.executionTimeMinutes % 1 !== 0 || fieldValues.executionTimeMinutes >= 60) ? "Not a valid Number" : "" : "Execution Time Minutes field is required."
    ...
    const handleSubmit = (e) => {
        ...
        // if (validate() && released && executedDate && environment && totalDefects >= 0 && totalTcs >= 0 && hours <= 0 ? minutes > 0 : minutes >= 0) {
        if (validate() && released && executedDate && environment && totalDefects >= 0 && totalTcs >= 0) {
            const payload = {
                environment: environment,
                run_id: currentRun._id,
            ...
            console.log(payload)
            axios.post(manualLaunchesEndpoint, payload).then(response => {
                toast.success('Manual entry submission successfull!')
                console.log(response.data)
                if (redirectToSamePage)
                    window.location.reload()
                else
                    navigate('/build-launches', { state: { tabIndex: 0, project: currentProject, build: currentBuild, runs: currentRun, activity: currentActivity } })
            ...
            <Form noValidate onSubmit={handleSubmit}>
                    ...
                    <Stack direction="row"
                        ...
                        <div>
                            <Grid container spacing={2}>
                                <Grid item>
                                    <Button onClick={() => navigate('/build-launches', { state: { tabIndex: 0, project: currentProject, build: currentBuild, activity: currentActivity, runs: currentRun } })} variant='outlined'><KeyboardBackspaceSharpIcon /></Button>
                                </Grid>
                                <Grid item>
                                    <p className='heading'>Add New Manual Entry</p>
                                </Grid>
                            </Grid>
                        </div>
                        <div>
                            <Button
                                onClick={() => navigate('/build-launches', { state: { tabIndex: 0, project: currentProject, build: currentBuild, activity: currentActivity, runs: currentRun } })}
                                variant="outlined"
                                sx={{ mr: 1 }}>cancel
                            </Button>
                            <Button
                ...
                <Paper sx={{ p: 2 }}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={3}>
                            <Typography variant='body2'>{currentProject.display_name}</Typography>
                        </Grid>
                        <Grid item xs={3}>
                        ...
                        <Grid item xs={9}>
                            <Typography variant='body2'>{currentProject.display_id}</Typography>
                        </Grid>
                                        ...
                                        renderInput={(params) => {
                                            return (
                                                <TextField
                                                    ...
                                                    helperText={executedDateError ? 'Executed Date is required!' : ''}
                        ...
                        <Grid item xs={3} sx={{ mt: 1 }}>
                            <FormControl error={releasedError}>
                                <FormLabel ><Typography variant='body2'>Release</Typography></FormLabel>
                                <RadioGroup row name="row-radio-buttons-group" onChange={(e) => handleReleaseChange(e)}>
                                    <FormControlLabel value={true} control={<Radio size="small" />} label="Yes" />
                                    <FormControlLabel value={false} control={<Radio size="small" />} label="No" />
                                </RadioGroup>
                                {releasedError ?
                                    <FormHelperText color>Release option is mandatory!</FormHelperText> : null}
                            </FormControl>
                        </Grid>
                    </Grid>
                </Paper>
                    ...
                    <Grid container spacing={2}>
                        ...
                        {/* <Grid item xs={2}>
                            <Input
                                ...
                                name="executionTime"
                                defaultValue={values.executionTime}
                                onChange={handleInputChange}
